...
import com.moko.lw003plus.databinding.Lw003PlusActivityTimingScanImmediatelyReportBinding;
...
public class TimingScanImmediatelyReportActivity extends BaseActivity implements BaseQuickAdapter.OnItemChildClickListener {

    private Lw003PlusActivityTimingScanImmediatelyReportBinding mBind;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBind = Lw003PlusActivityTimingScanImmediatelyReportBinding.inflate(getLayoutInflater());
...
//        mAdapter.setOnItemSwipeListener(onItemSwipeListener);
        ...
        mBind.etScanDuration.postDelayed(() -> {
            ...
            orderTasks.add(OrderTaskAssembler.getTimingScanImmediatelyReportDuration());
            orderTasks.add(OrderTaskAssembler.getTimingScanImmediatelyReportTimePoint());
...
//    };
    ...
    public void onSave(View view) {
        ...
        showSyncingProgressDialog();
        List<OrderTask> orderTasks = new ArrayList<>();
        orderTasks.add(OrderTaskAssembler.setTimingScanImmediatelyReportDuration(duration));
        ...
        orderTasks.add(OrderTaskAssembler.setTimingScanImmediatelyReportTimePoint(points));
        LoRaLW003PlusMokoSupport.getInstance().sendOrder(orderTasks.toArray(new OrderTask[]{}));
        if (mHandler.hasMessages(0))
            mHandler.removeMessages(0);
        mHandler.postDelayed(() -> {
