...
import com.moko.lw003plus.databinding.Lw003ProActivityPayloadMkPirContentBinding;
...
public class PayloadMKPIRContentActivity extends BaseActivity {
    ...
    private Lw003ProActivityPayloadMkPirContentBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003ProActivityPayloadMkPirContentBinding.inflate(getLayoutInflater());
