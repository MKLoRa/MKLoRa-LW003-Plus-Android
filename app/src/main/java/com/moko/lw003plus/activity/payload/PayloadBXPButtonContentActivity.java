...
import com.moko.lw003plus.databinding.Lw003ProActivityPayloadBxpButtonContentBinding;
...
public class PayloadBXPButtonContentActivity extends BaseActivity {
    ...
    private Lw003ProActivityPayloadBxpButtonContentBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003ProActivityPayloadBxpButtonContentBinding.inflate(getLayoutInflater());
