...
import com.moko.lw003plus.utils.FileUtils;
                            ...
                            if (flag == 0x00) {
                                ...
                                switch (configKeyEnum) {
                                    ...
                                    case KEY_PAYLOAD_IBEACON_CONTENT:
                                        mPayloadFlag.iBeaconFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
                                    case KEY_PAYLOAD_EDDYSTONE_UID_CONTENT:
                                        mPayloadFlag.EddystoneUIDFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
                                    case KEY_PAYLOAD_EDDYSTONE_URL_CONTENT:
                                        mPayloadFlag.EddystoneURLFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
                                    case KEY_PAYLOAD_EDDYSTONE_TLM_CONTENT:
                                        mPayloadFlag.EddystoneTLMFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
                                    case KEY_PAYLOAD_BXP_IBEACON_CONTENT:
                                        mPayloadFlag.BXPiBeaconFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
                                    case KEY_PAYLOAD_BXP_DEVICE_INFO_CONTENT:
                                        mPayloadFlag.BXPDeviceInfoFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
                                    case KEY_PAYLOAD_BXP_ACC_CONTENT:
                                        mPayloadFlag.BXPACCFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
                                    case KEY_PAYLOAD_BXP_TH_CONTENT:
                                        mPayloadFlag.BXPTHFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
                                    case KEY_PAYLOAD_BXP_TAG_CONTENT:
                                        mPayloadFlag.BXPTagFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
                                    case KEY_PAYLOAD_BXP_BUTTON_CONTENT:
                                        mPayloadFlag.BXPButtonFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
                                    case KEY_PAYLOAD_BXP_TOF_CONTENT:
                                        mPayloadFlag.BXPTOFFlag = MokoUtils.toInt(Arrays.copyOfRange(value, 5, 5 + length));
                                        break;
