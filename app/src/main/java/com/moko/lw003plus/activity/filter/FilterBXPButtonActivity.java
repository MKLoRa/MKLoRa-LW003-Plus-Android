...
import com.moko.lw003plus.databinding.Lw003ProActivityFilterBxpButtonBinding;
...
public class FilterBXPButtonActivity extends BaseActivity {
    ...
    private Lw003ProActivityFilterBxpButtonBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003ProActivityFilterBxpButtonBinding.inflate(getLayoutInflater());
