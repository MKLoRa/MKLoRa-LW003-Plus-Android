...
import com.moko.lw003plus.databinding.Lw003PlusActivityPayloadBxpTagContentBinding;
...
public class PayloadBXPTagContentActivity extends BaseActivity {
    ...
    private Lw003PlusActivityPayloadBxpTagContentBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003PlusActivityPayloadBxpTagContentBinding.inflate(getLayoutInflater());
