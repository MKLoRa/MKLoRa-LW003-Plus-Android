...
import com.moko.lw003plus.databinding.Lw003ProActivityPayloadIbeaconContentBinding;
...
public class PayloadIBeaconContentActivity extends BaseActivity {
    ...
    private Lw003ProActivityPayloadIbeaconContentBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003ProActivityPayloadIbeaconContentBinding.inflate(getLayoutInflater());
