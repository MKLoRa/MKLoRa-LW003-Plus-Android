...
import com.moko.lw003plus.databinding.Lw003ProActivityPayloadMkTofContentBinding;
...
public class PayloadMKTOFContentActivity extends BaseActivity {
    ...
    private Lw003ProActivityPayloadMkTofContentBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003ProActivityPayloadMkTofContentBinding.inflate(getLayoutInflater());
