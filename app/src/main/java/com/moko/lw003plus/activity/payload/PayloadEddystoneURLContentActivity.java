...
import com.moko.lw003plus.databinding.Lw003ProActivityPayloadEddystoneUrlContentBinding;
...
public class PayloadEddystoneURLContentActivity extends BaseActivity {
    ...
    private Lw003ProActivityPayloadEddystoneUrlContentBinding mBind;
    private boolean savedParamsError;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mBind = Lw003ProActivityPayloadEddystoneUrlContentBinding.inflate(getLayoutInflater());
