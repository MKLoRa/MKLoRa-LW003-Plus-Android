        ...
        if (header == 0xEE && flag == 0x00) {
            ...
            if (Objects.requireNonNull(keyEnum) == ParamsKeyEnum.KEY_FILTER_NAME_RULES) {
                ...
                if (packetIndex == (packetCount - 1)) {
                    ...
                    LoRaLW003PlusMokoSupport.getInstance().pollTask();
                    LoRaLW003PlusMokoSupport.getInstance().executeTask();
                    LoRaLW003PlusMokoSupport.getInstance().orderResult(response);
                }
            }
            return false;
        }
